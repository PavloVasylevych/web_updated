...
const AccountEdit = () => {
    ...
    const editUser = request_body => {
        return fetch('http://localhost:8089/api/v1/user/alex123', {
            method: "PUT",
    ...
    const editButtonHandler = async e => {
        ...
        return (<div className="main">
            <Header/>
            <form data-testid="RegForm" className="form">
                <h1>Edit account</h1>
                <div>
                    <label>
                ...
                <div>
                    <button data-testid="edit" className="edit_button" onClick={editButtonHandler}>Save</button>
                </div>
                <div>
                    <button data-testid="delete" className="delete_button" onClick={deleteButtonHandler}>Delete</button>
                </div>
